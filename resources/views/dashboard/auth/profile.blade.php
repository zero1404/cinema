  ...
  <div class="col-12 col-xl-8">
    <div class="card card-body border-0 shadow mb-4">
      ...
      <form method="post" action="">
        ...
        <div class="row">
          <div class="col-md-6">
            <x-Dashboard.Forms.Input name="Họ" property="lastname" type="text" placeholder="Nhập họ"
              value="{{ auth()->user()->lastname }}" />
          </div>

          <div class="col-md-6">
            <x-Dashboard.Forms.Input name="Tên" property="firstname" type="text" placeholder="Nhập tên"
